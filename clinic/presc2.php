...
$sql = "SELECT * FROM medications WHERE pre_id='$pre_id'";
...
<div >
  <section>
    <div class="main-div">
    <h1>Medicines of the prescription ID : <?php echo $pre_id;?></h1>
  ...
  ?><p style="color: red;text-align: center;">No medicines found!!</p>
<?php
}
        ?>
     ...
     <div>
    <a href="prescription.php"><button class="btn btn-outline-success my-2 my-sm-0" style="font-size: 25px;font-weight: bold;"><i class="fas fa-hand-point-left fa-1.5x" style="padding-top: 0px; padding-right: 5px;"></i>Back</button></a>
</div>
   </div>
  </section>
